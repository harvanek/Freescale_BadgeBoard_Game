/*!
 * \file    ramvector.c
 * \brief   Redirection of user entry point to USER_ENTRY_ADDRESS
 *          and interrupt vectors to REDIRECT_VECTORS RAM addresses
...
void  (* const RAM_vector[])()@REDIRECT_VECTORS= {
  ...
  (pFun)&irq_interrupt,         // vector_64 Virq
  ...
  (pFun)&rtc_interrupt,         // vector_91 Vrtc
